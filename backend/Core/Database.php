 ...
 * @class Database
 */
class Database extends CrudBase
{
    ...
    */
    ...
    private function __construct(){
       try {
		   ...
		   $this->_connection->setAttribute(\PDO::ATTR_STRINGIFY_FETCHES, false);
       ...
       {
			self::CrudMsgLog($e->getMessage());
           echo json_encode(['e' => true, 'm' =>  'Server Error']);
           die();
       }
    }
